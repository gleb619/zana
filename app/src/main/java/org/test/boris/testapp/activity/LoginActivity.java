...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "foo@example.com:hello", "bar@example.com:world", "root1:root1"
    };
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView.setText("root1");
        mPasswordView.setText("root1");
...
//        return email.contains("@");
    ...
    public void successLogin(String username, String password){
        ...
        credentials.setKey(securityUtil.sha256(username + password));
